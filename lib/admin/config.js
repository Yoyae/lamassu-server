...
const ALL_CRYPTOS = ['BTC', 'ETH', 'LTC', 'DASH', 'XMCC', 'ZEC', 'BCH']
  ...
  return machineLoader.getMachineNames()
    .then(machineList => ({
      ...
      accounts: [
        ...
        {code: 'coinmarketcap', display: 'CoinMarketCap', class: 'ticker', cryptos: ['BTC', 'ETH', 'LTC', 'ZEC', 'BCH', 'DASH', 'XMCC']},
        ...
        {code: 'monoecid', display: 'monoecid', class: 'wallet', cryptos: ['XMCC']},
        ...
        {code: 'all-zero-conf', display: 'Always 0-conf', class: 'zeroConf', cryptos: ['BTC', 'ZEC', 'LTC', 'DASH', 'BCH', 'XMCC']},
        ...
        {code: 'mock-zero-conf', display: 'Mock 0-conf', class: 'zeroConf', cryptos: ['BTC', 'ZEC', 'LTC', 'DASH', 'BCH', 'XMCC']}
      ],
